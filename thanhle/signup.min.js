...
(function(){var b=function(a,b,c,e,g){a.init=function(){a.total=120;a.formData={};a.listIndex=0;a.signups=[];a.nav={};d()};a.submit=function(){var f=[],k=a.formData;a.signupData=[];e.loadSignups().then(function(h){a.signups=h;a.signups.forEach(function(b){var h=a.formData[b.date],c=b.data.find(function(a){return h.name&&a.name===h.name}),d=0;b.data.forEach(function(a){a.order>d&&(d=a.order)});c?(c.name=k.name,c.email=k.email,c.phone=k.phone,c.count=h.count,!c.order&&(c.order=d+1)):(c=g.pick(k,"name",
"email","phone"),c.count=h.count,c.order=d+1,b.data.push(c));f.push(e.updateSignup(b).then(function(){0<c.count&&(Object.assign(c,g.pick(b,"date","liturgy")),a.signupData.push(c))}))});b.all(f).then(function(){a.signupData.sort(function(a,b){b=b.date;return a.date.getTime()<b.getTime()?-1:1});location.hash="/summary"})})};a.delete=function(b,c){confirm("Are you sure to delete name: "+c.name+" and email: "+c.email+"?")&&e.loadSignups().then(function(f){a.signups=f;var h=a.signups.find(function(a){return a.date.getTime()===
b.getTime()});h.data.forEach(function(a,b){a.name===c.name&&a.email===c.email&&h.data.splice(b,1)});e.updateSignup(h)})};a.formatDate=function(a,b){var c=a.toLocaleTimeString([],{hour:"numeric",minute:"2-digit"});a=$.datepicker.formatDate("dd/mm/yy",a);return a+" @"+c+" - "+b};a.formatPhone=function(a){return(a||"").replace(/(\d{3})(\d{3})(\d{4})/,"($1) $2-$3")};a.getRemaining=function(b){var c=a.signups.find(function(a){return a.date.getTime()===b.getTime()}),f=a.total;c.data.forEach(function(a){f-=
a.count||0});return f};a.checkSignup=function(){var b=a.formData;b&&(a.signups.forEach(function(c){a.formData[c.date]={};c.data.forEach(function(a){var c=b.name&&g.neutralize(a.name,!0).match(new RegExp(g.neutralize(b.name,!0)+"$","i")),d=b.email&&a.email===b.email,f=b.phone&&a.phone===b.phone;if(c||d||f)g.neutralize(a.name,!0)!==g.neutralize(b.name,!0)&&(b.name=a.name),void 0===b.name&&(b.name=a.name),void 0===b.email&&(b.email=a.email),void 0===b.phone&&(b.phone=a.phone)})}),a.signups.forEach(function(c){a.formData[c.date].name=
...
b.date;b=a.formData[c];c=a.getRemaining(c);b&&(b.error=null,b.count>c&&(b.error="Kh\u00f4ng c\u00f2n \u0111\u1ee7 ch\u1ed7 cho "+b.count+" ng\u01b0\u1eddi",a.disableSave="disabled"))})};a.prevList=function(){$("html").scrollTop(0,0);0<a.listIndex&&--a.listIndex;l()};a.nextList=function(){a.listIndex<a.signups.length-1&&(a.listIndex+=1);$("html").scrollTop(0,0);l()};var d=function(){a.signups&&0!==a.signups.length||m();c.addEventListener("hashchange",function(b){a.signups?(/\/signup$/.test(b.newURL)&&
a.$apply(function(){a.formData={}}),/\/summary$/.test(b.newURL)&&!a.signupData&&(location.hash="/signup")):m()})},m=function(){e.loadSignups().then(function(b){a.signups=b;l();/\/(signup|list)$/.test(location.hash)||(location.hash="/signup")})},l=function(){a.nav.prev=0===a.listIndex?"disabled":"";a.nav.next=a.listIndex===a.signups.length-1?"disabled":""}};b.$inject=["$scope","$q","$window","ParishService","AppUtil"];app.controller("thanhle",b)})();
