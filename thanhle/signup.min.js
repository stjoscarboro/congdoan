...
(function(){var b=function(a,b,c,e,g){a.init=function(){a.total=90;a.formData={};a.listIndex=0;a.signups=[];a.nav={};d()};a.submit=function(){var f=[],k=a.formData;a.signupData=[];e.loadSignups().then(function(h){a.signups=h;a.signups.forEach(function(b){var h=a.formData[b.date],c=b.data.find(function(a){return h.name&&a.name===h.name}),d=0;b.data.forEach(function(a){a.order>d&&(d=a.order)});c?(c.name=k.name,c.email=k.email,c.phone=k.phone,c.count=h.count,!c.order&&(c.order=d+1)):(c=g.pick(k,"name",
