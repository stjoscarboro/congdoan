...
a.count||0});return f};a.checkSignup=function(){var b=a.formData;b&&(a.signups.forEach(function(c){a.formData[c.date]=a.formData[c.date]||{};c.data.forEach(function(a){var c=b.name&&g.neutralize(a.name,!0).match(new RegExp(g.neutralize(b.name,!0)+"$","i")),f=b.email&&a.email===b.email,d=b.phone&&a.phone===b.phone;if(c||f||d)f||d||(b.name=a.name),void 0===b.name&&(b.name=a.name),void 0===b.email&&(b.email=a.email),void 0===b.phone&&(b.phone=a.phone)})}),a.signups.forEach(function(c){a.formData[c.date].name=
...
function(b){a.signups?(/\/signup$/.test(b.newURL)&&a.$apply(function(){a.formData={}}),/\/summary$/.test(b.newURL)&&!a.signupData&&(location.hash="/signup")):m()})},m=function(){e.loadSignups().then(function(b){a.signups=b;l();/\/(signup|list)$/.test(location.hash)||(location.hash="/signup")})},l=function(){var b=0;a.signups.forEach(function(c,d){c.list&&0===a.listIndex&&(a.listIndex=d,b++)});a.nav.prev=0===a.listIndex||a.listIndex===b?"disabled":"";a.nav.next=a.listIndex===a.signups.length-1?"disabled":
